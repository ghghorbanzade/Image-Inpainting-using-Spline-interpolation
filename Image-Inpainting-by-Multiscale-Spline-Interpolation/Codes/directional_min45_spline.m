...
%                     x2 = [x2 , c_i(j,ir(ind(k))-x,ic(ind(k))+1)];
                ...
                row_x1 = 1+edge_w:ir(ind(k))-(i_x2);
                col_x1 = 1+edge_w:ic(ind(k))-(i_x2);
                num_r1 = length(row_x1);
                num_c1 = length(col_x1);
                num_x1 = min(num_r1, num_c1);
                if ir(ind(k))-(i_x2)-(i_x1)+1-edge_w > 0 && ic(ind(k))-(i_x2)-(i_x1)+1-edge_w > 0
                ...
                elseif ir(ind(k))-(i_x2)- num_x1-edge_w+1> 0 && ic(ind(k))-(i_x2)-num_x1-edge_w+1> 0
%                     row_x1 = 1+edge_w:ir(ind(k))-(i_x2);
%                     col_x1 = 1+edge_w:ic(ind(k))-(i_x2);
%                     num_r1 = length(row_x1);
%                     num_c1 = length(col_x1);
%                     num_x1 = min(num_r1, num_c1);
                    ...
                    row_x1 = ir(ind(k))-(i_x2) - num_x1-edge_w+1:ir(ind(k))-(i_x2)-edge_w;
                    indexes = sub2ind([r,c],row_x1,col_x1);
                ...
                if ir(ind(k))+(i_x1)+(i_x2)-1+edge_w < r+1 && ic(ind(k))+(i_x1)+(i_x2)-1+edge_w < c+1
                    row_x2 = [];
                    col_x2 = [];
...
%                     x2 = c_i(j,ir(ind(k))+i_x1+1:ir(ind(k))+(i_x1)+(i_x2),ic(ind(k)));
                elseif ir(ind(k))+i_x1+edge_w+num_x2< r+1 && ic(ind(k))+i_x1+edge_w+num_x2< c+1
%                     row_x2 = ir(ind(k))+i_x1:r;%r-edge_w;
%                     col_x2 = ic(ind(k))+i_x1:c;%c-edge_w;
%                     num_r2 = length(row_x2);
%                     num_c2 = length(col_x2);
%                     num_x2 = min(num_r2 , num_c2);
                    ...
                    row_x2 = [];
                    col_x2 = [];
                    col_x2 = ic(ind(k))+i_x1+edge_w:ic(ind(k))+(i_x1)+num_x2+edge_w-1;
                    row_x2 = ir(ind(k))+i_x1-edge_w:ir(ind(k))+i_x1+num_x2-edge_w-1;
                    indexes = sub2ind([r,c],row_x2,col_x2);
