...
%                     x2 = [x2 , c_i(j,ir(ind(k))-x,ic(ind(k))+1)];
                ...
                if ir(ind(k))-(i_x2)-(i_x1)+1 > 0 && ic(ind(k))+(i_x2)+(i_x1) < c+1
...
%                     x1 = c_i(j,ir(ind(k))-2*(i_x2)+1:ir(ind(k))-(i_x2),ic(ind(k)));
                elseif ir(ind(k))-(i_x2)> 0 || ic(ind(k))+(i_x2)< c+1
...
%                     x1 = c_i(j,ir(ind(k)),1:ic(ind(k)-(i_x2))); 
                ...
                %%%%%%%%%%
                if ir(ind(k))+(i_x1)+(i_x2) < r+1 && ic(ind(k))-(i_x1)-(i_x2)+1 > 0
...
%                     x2 = c_i(j,ir(ind(k))+i_x1+1:ir(ind(k))+(i_x1)+(i_x2),ic(ind(k)));
                elseif ir(ind(k))+i_x1< r+1 || ic(ind(k))-i_x1> 0
